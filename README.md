...
# **Scenario**
***
The Cyclistic Case Study is one of the [capstone projects of Google Data Analytics](https://github.com/Catarinaperiquito/Google-Data-Analytics---Cyclistic-Case-Study/blob/main/Case-Study-1(1).pdf), a professional certificate program offered on Coursera. 
